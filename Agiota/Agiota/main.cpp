...
public:
    ...
    void shell(string line){
        ...
        if(op == "init"){
            ...
            agiota.repCli.remove(idCli);
            for(auto chave : agiota.repTr.getKeys()){
                if(agiota.repTr.get(chave).idCli == idCli)
                    agiota.repTr.remove(chave);
            }
            cout << "done"<< endl;
